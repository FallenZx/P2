				...
				<li>
					<div class="user-view">
						...
						<a href="#user"><img class="circle"
								src="https://cdn5.vectorstock.com/i/1000x1000/01/69/businesswoman-character-avatar-icon-vector-12800169.jpg"></a>
						<h1>
						<a href="#name" class="black-text">
								<?php echo ucwords($_SESSION['data']['nama_petugas']); ?>
							</a>
						</h1>
					</div>
				</li>
