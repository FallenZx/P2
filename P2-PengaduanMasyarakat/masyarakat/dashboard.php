<table class="responsive-table" border="2" style="width: 100%;">
	<tr>
		...
		<td>
			<h4 class="orange-text hide-on-med-and-down">Daftar Laporan</h4>
		</td>
	</tr>
	<tr>
			...
			<table border="3" class="responsive-table striped highlight">
				...
				while ($r = mysqli_fetch_assoc($pengaduan)) { ?>
					<tr>
						...
						<td>
							<?php echo $r['tgl_pengaduan']; ?>
						</td>
						<td>
							<?php echo $r['status']; ?>
						</td>
						<td>
							<a class="btn blue modal-trigger"
								href="#tanggapan&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">More</a>
							<a class="btn red" onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')"
								href="index.php?p=pengaduan_hapus&id_pengaduan=<?php echo $r['id_pengaduan'] ?>">Hapus</a>
						</td>
						...
						<div id="tanggapan&id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
							<div class="modal-content">
								...
								<div class="col s12">
									...
									<p>Petugas :
										<?php echo $r['nama_petugas']; ?>
									</p>
									<p>Tanggal Masuk :
										<?php echo $r['tgl_pengaduan']; ?>
									</p>
									<p>Tanggal Ditanggapi :
										<?php echo $r['tgl_tanggapan']; ?>
									</p>
									<?php
									if ($r['foto'] == "kosong") { ?>
